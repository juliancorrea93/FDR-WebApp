...
$sql = "SELECT r.rname, m.menuname, mi.menuitemname, mi.price FROM restaurants r INNER JOIN menus m ON r.rid = m.rid INNER JOIN menuitems mi ON m.menuid = mi.menuid WHERE r.rname = \"".$restaurant."\"";
